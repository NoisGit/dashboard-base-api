...
- [x] Ajustar endpoints públicos con nombres más genéricos orientados a operadores (`operator`) en lugar de dominios de control de acceso físico.
...
- [ ] Revisar migraciones históricas del rol `OPERATOR` antes de conectar bases de datos existentes.
